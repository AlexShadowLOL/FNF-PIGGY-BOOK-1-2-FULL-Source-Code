...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:String = 'normal', ?noteSkin:String = 'normal')
	{
		...
		{
			switch (book1.PlayStateB1.SONG.noteStyle)
			{
				case 'pixel':
					...
					setGraphicSize(Std.int(width * book1.PlayStateB1.daPixelZoom));
					updateHitbox();
		...
		if (isSustainNote && prevNote != null)
		{
			...
			if (FlxG.save.data.curBook == 'book1')
			{
				if (book1.PlayStateB1.curStage.startsWith('school'))
				{
					x += 30;
				}
			}
			...
			if (prevNote.isSustainNote)
			{
				...
				{
					if (FlxG.save.data.curBook == 'book1')
						prevNote.scale.y *= Conductor.stepCrochet / 100 * 1.5 * book1.PlayStateB1.SONG.speed;
					else
