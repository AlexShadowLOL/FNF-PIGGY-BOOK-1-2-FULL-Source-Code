...
class PlayState extends MusicBeatState
{
	...
	var appTitleSongs:Array<String> = [
		"FNF: PIGGY BOOK 2 - AlexShadow - On The Hunt",
		"FNF: PIGGY BOOK 2 - AlexShadow - In Stock",
		"FNF: PIGGY BOOK 2 - AlexShadow - Encounters",
		"FNF: PIGGY BOOK 2 - AlexShadow - Intruders",
		"FNF: PIGGY BOOK 2 - AlexShadow - Farewell",
		"FNF: PIGGY BOOK 2 - AlexShadow - Metal Escape",
		"FNF: PIGGY BOOK 2 - AlexShadow - Underground",
		"FNF: PIGGY BOOK 2 - AlexShadow - Our Battle",
		"FNF: PIGGY BOOK 2 - AlexShadow - Change",
		"FNF: PIGGY BOOK 2 - AlexShadow - Deep Sea",
		"FNF: PIGGY BOOK 2 - AlexShadow - All Aboard",
		"FNF: PIGGY BOOK 2 - AlexShadow - Teleport",
		"FNF: PIGGY BOOK 2 - AlexShadow - Sneaky",
		"FNF: PIGGY BOOK 2 - AlexShadow - Cold Blood",
		"FNF: PIGGY BOOK 2 - AlexShadow - Once For All",
		"FNF: PIGGY BOOK 2 - AlexShadow - Run Away",
		"FNF: PIGGY BOOK 2 - AlexShadow - Almost",
		"FNF: PIGGY BOOK 2 - Saru & AlexShadow - Promenade (Zizzy Mix)",
		"FNF: PIGGY BOOK 2 - AlexShadow - No Male Bitches",
		"FNF: PIGGY BOOK 2 - AlexShadow - Friendzone",
		"FNF: PIGGY BOOK 2 - AlexShadow - Extermination",
		"FNF: PIGGY BOOK 2 - AlexShadow - Forgotten Past",
		"FNF: PIGGY BOOK 2 - AlexShadow - Hide And Seek",
		"FNF: PIGGY BOOK 2 - AlexShadow - Frost Fate",
		"FNF: PIGGY BOOK 2 - AlexShadow - Overseer",
		"FNF: PIGGY BOOK 2 - AlexShadow - Swing It",
		"FNF: PIGGY BOOK 2 - AlexShadow - Despair"
	];
	...
	var whiteVoid:FlxSprite;
	var whiteVoidEvil:FlxSprite;
	var distBG:FlxSprite;
	var campOutdoors:FlxSprite;
	var tioBG:FlxSprite;
	var heistBG:FlxSprite;
	var heistPillars:FlxSprite;
	var stageBG:FlxSprite;
	var bkoutBG:FlxSprite;
	var bkoutLight:FlxSprite;
	...
	override public function create()
	{
		...
		{
			FlxG.sound.cache(Paths.instRematch(PlayState.SONG.song));
			FlxG.sound.cache(Paths.voicesRematch(PlayState.SONG.song));	
		}
		
		switch (SONG.song.toLowerCase())
		{
			case 'on-the-hunt': curSelSong = 0;
			case 'in-stock': curSelSong = 1;
			case 'encounters': curSelSong = 2;
			case 'intruders': curSelSong = 3;
			case 'farewell': curSelSong = 4;
			case 'metal-escape': curSelSong = 5;
			case 'underground': curSelSong = 6;
			case 'our-battle': curSelSong = 7;
			case 'change': curSelSong = 8;
			case 'deep-sea': curSelSong = 9;
			case 'all-aboard': curSelSong = 10;
			case 'teleport': curSelSong = 11;
			case 'sneaky': curSelSong = 12;
			case 'cold-blood': curSelSong = 13;
			case 'once-for-all': curSelSong = 14;
			case 'run-away': curSelSong = 15;
			case 'almost': curSelSong = 16;
			case 'promenade': curSelSong = 17;
			case 'no-male-bitches': curSelSong = 18;
			case 'friendzone': curSelSong = 19;
			case 'extermination': curSelSong = 20;
			case 'forgotten-past': curSelSong = 21;
			case 'hide-and-seek': curSelSong = 22;
			case 'frost-fate': curSelSong = 23;
			case 'overseer': curSelSong = 24;
			case 'swing-it': curSelSong = 25;
			case 'despair': curSelSong = 26;
		}
		...
		switch(SONG.stage)
		{
			...
			case 'whitevoid':
				{
					...
					whiteVoid = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/whitevoid', 'april-fools'));
					whiteVoid.setGraphicSize(Std.int(whiteVoid.width * 1.6));
					whiteVoid.updateHitbox();
					whiteVoid.antialiasing = true;
					whiteVoid.scrollFactor.set(1, 0.9);
					add(whiteVoid);	

					trace("LOADED 'White Void' STAGE.");		
				}
			case 'whitevoidevil':
				{
					defaultCamZoom = 0.75;
					curStage = 'whitevoidevil';

					var stagePosX = -700;
					var stagePosY = -520;
					
					whiteVoidEvil = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/whitevoidevil', 'april-fools'));
					whiteVoidEvil.setGraphicSize(Std.int(whiteVoidEvil.width * 1.6));
					whiteVoidEvil.updateHitbox();
					whiteVoidEvil.antialiasing = true;
					whiteVoidEvil.scrollFactor.set(1, 0.9);
					add(whiteVoidEvil);	

					trace("LOADED 'White Void EVIL' STAGE.");		
				}
			...
			case 'winter':
			{
				...
				var bgBG:FlxSprite = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/winter/poorlyDrawnIce', 'piggy'));
				bgBG.setGraphicSize(Std.int(bgBG.width * 1.6));
				bgBG.updateHitbox();
				bgBG.antialiasing = true;
				bgBG.scrollFactor.set(1, 0.9);
				add(bgBG);

				var floorOk:FlxSprite = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/winter/floor', 'piggy'));
				floorOk.setGraphicSize(Std.int(floorOk.width * 1.6));
				floorOk.updateHitbox();
				floorOk.antialiasing = true;
				floorOk.scrollFactor.set(1, 0.9);
				add(floorOk);

				treeFG = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/winter/fgTrees', 'piggy'));
				treeFG.setGraphicSize(Std.int(treeFG.width * 1.6));
				treeFG.updateHitbox();
				treeFG.antialiasing = true;
				treeFG.scrollFactor.set(1, 0.9);
				...
				trace("LOADED 'Winter' STAGE.");	
			}

			case 'distraction':
			{
				defaultCamZoom = 0.75;
                curStage = 'distraction';

				var stagePosX = -700;
				var stagePosY = -520;

				distBG = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/distraction/distRefinery', 'piggy'));
				distBG.setGraphicSize(Std.int(distBG.width * 1.6));
				distBG.updateHitbox();
				distBG.antialiasing = true;
				distBG.scrollFactor.set(1, 0.9);
				add(distBG);	
				
				trace("LOADED 'Distraction' STAGE.");	
			}

			case 'campoutdoor':
			{
				defaultCamZoom = 0.55;
                curStage = 'campoutdoor';

				var stagePosX = -700;
				var stagePosY = -520;

				campOutdoors = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/chapter12/campOutdoors', 'piggy'));
				campOutdoors.setGraphicSize(Std.int(campOutdoors.width * 1.6));
				campOutdoors.updateHitbox();
				campOutdoors.antialiasing = true;
				campOutdoors.scrollFactor.set(1, 0.9);
				add(campOutdoors);
				
				trace("LOADED 'Camp Outdoors' STAGE.");	
			}
			...
			case 'portals':
			{
				...
				tioBG = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/portals/bg', 'piggy'));
				tioBG.setGraphicSize(Std.int(tioBG.width * 1.6));
				tioBG.antialiasing = true;
				tioBG.scrollFactor.set(1, 0.9);
				tioBG.scale.set(2, 2);
				tioBG.updateHitbox();
				add(tioBG);
				
				trace("LOADED 'TIO Portals' STAGE.");	
			}
			...
			case 'heist':
			{
				...
				heistBG = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/heist/poorlyDrawnBG', 'piggy'));
				heistBG.setGraphicSize(Std.int(heistBG.width * 1.6));
				heistBG.updateHitbox();
				heistBG.antialiasing = true;
				heistBG.scrollFactor.set(1, 0.9);
				add(heistBG);

				heistPillars = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/heist/pilars', 'piggy'));
				heistPillars.setGraphicSize(Std.int(heistPillars.width * 1.6));
				heistPillars.updateHitbox();
				heistPillars.antialiasing = true;
				heistPillars.scrollFactor.set(1, 0.9);
				
				trace("LOADED 'Heist' STAGE.");	
			}
			...
			case 'stage':
			{
				...
				stageBG = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/stage/stageBG', 'piggy'));
				stageBG.setGraphicSize(Std.int(stageBG.width * 1.6));
				stageBG.updateHitbox();
				stageBG.antialiasing = true;
				stageBG.scrollFactor.set(1, 0.9);
				add(stageBG);
				
				trace("LOADED 'Stage' STAGE.");	
			}
			...
			case 'breakout':
			{
				...
				bkoutBG = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/breakout/breakoutBG', 'piggy'));
				bkoutBG.setGraphicSize(Std.int(bkoutBG.width * 1.6));
				bkoutBG.updateHitbox();
				bkoutBG.antialiasing = true;
				bkoutBG.scrollFactor.set(1, 0.9);
				add(bkoutBG);

				bkoutLight = new FlxSprite(stagePosX, stagePosY).loadGraphic(Paths.image('bgs/breakout/breakoutLight(Blend-Add)', 'piggy'));
				bkoutLight.setGraphicSize(Std.int(bkoutLight.width * 1.6));
				bkoutLight.updateHitbox();
				bkoutLight.antialiasing = true;
				bkoutLight.scrollFactor.set(1, 0.9);
				bkoutLight.blend = ADD;
				
				trace("LOADED 'Breakout' STAGE.");	
			}
		}
		...
		switch (curSong.toLowerCase()) // setting health bar colours for every song
		{
			...
			case 'encounters' | 'change' | 'hide-and-seek': // chapter 6 + extra
			{
				if (curSong.toLowerCase() == 'hide-and-seek')
					healthBar.createFilledBar(0xFFCA1F7B, 0xFF710193);
				else
			...
			case 'all-aboard' | 'no-male-bitches' | 'friendzone' | 'extermination': // chapter 8 and also april fools lol
			{
			...
			case 'almost':
			{
				var ponyHealth = FlxColor.YELLOW;

				healthBar.createFilledBar(ponyHealth, ponyHealth);
				trace("GENERATED HEALTH BAR COLOURS.");
			}
			...
			case 'frost-fate': // extra
			{
				var frostiggyHealth = FlxColor.CYAN;

				healthBar.createFilledBar(frostiggyHealth, 0xFF808080);
				trace("GENERATED HEALTH BAR COLOURS.");
			}
			case 'overseer': // extra
			{
				var tioHealth = FlxColor.ORANGE;

				healthBar.createFilledBar(tioHealth, 0xFF808080);
				trace("GENERATED HEALTH BAR COLOURS.");
			}
			case 'forgotten-past': // extra
			{
				var ponyHealth = FlxColor.YELLOW;
				var poleyHealth = FlxColor.BLUE;

				healthBar.createFilledBar(poleyHealth, ponyHealth);
				trace("GENERATED HEALTH BAR COLOURS.");
			}
			case 'swing-it': // extra
			{
				var felixHealth = FlxColor.GREEN;

				healthBar.createFilledBar(felixHealth, 0xFF808080);
				trace("GENERATED HEALTH BAR COLOURS.");
			}
			case 'despair': // extra
			{
				var ombraHealth = FlxColor.BLACK;

				healthBar.createFilledBar(ombraHealth, 0xFFFFA500);
				trace("GENERATED HEALTH BAR COLOURS.");
			}
			default: // in case it doesn't find the song for some reason hjfhihixghd (to prevent crashes)
			{
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + currentDifficulty + (Main.watermarks ? " - KE " + MainMenuState.kadeEngineVer : ""), 16);
		...
		newWatermark.cameras = [camHUD];
		    ...
		    newWatermark.text = "FNF PIGGY BOOK 2 " + MainMenuState.fnfPiggyBook2Ver
		...
		if (curSong.toLowerCase() == 'farewell' || curSong.toLowerCase() == 'almost' || curSong.toLowerCase() == 'despair')
		...
		if (curSong.toLowerCase() == 'despair' && FlxG.save.data.shaders)
		{
			...
			trace("SET CHROMATIC ABERRATION SHADER ON " + SONG.song.toUpperCase() + " WITH AN OFFSET OF " + chromOffset);
		}
	...
	public function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			switch (swagCounter)
			{
				...
				case 1:
					if (curSong.toLowerCase() != 'despair')
				...
				case 4:
					if (curSong.toLowerCase() == 'despair')
						FlxTween.tween(blackCountdown, {alpha: 0}, 5);
			}
	...
	function addingCharacterStuff()
    {
        switch (curSong.toLowerCase())
        {
			...
			case 'no-male-bitches' | 'friendzone' | 'extermination':
				add(dad);
				add(boyfriend);
	...
	function startSong():Void
	{
		...
		if (!paused)
		{
			if (storyDifficulty != 1)
				...
				FlxG.sound.playMusic(Paths.instRematch(PlayState.SONG.song), FlxG.save.data.instVol, false);
		}

		if (curSong.toLowerCase() == 'swing-it')
		    FlxG.sound.music.onComplete = endSongTwo;
		else
	...
	private function generateSong(dataPath:String):Void
	{
		...
		{
			if (SONG.needsVoices)
				vocals = new FlxSound().loadEmbedded(Paths.voicesRematch(PlayState.SONG.song));
			else
				vocals = new FlxSound();	
		}
	...
	{
		if (PlayState.curSong.toLowerCase() == 'despair')
		{
			FlxTween.tween(FlxG.camera, {zoom: 0.85}, (Conductor.stepCrochet * 4 / 1000), {ease: FlxEase.cubeOut});
			defaultCamZoom = 0.85;	
		}
		else
		{
		...
		if (generatedMusic && PlayState.SONG.notes[Std.int(curStep / 16)] != null)
		{
			...
			if (!FlxG.save.data.parallax)
			{
				if (camFollow.x != dadPos[0] && !PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection)
				{
					...
					if (PlayState.curSong.toLowerCase() == 'no-male-bitches' ||
						PlayState.curSong.toLowerCase() == 'friendzone' ||
						PlayState.curSong.toLowerCase() == 'extermination' ||
						PlayState.curSong.toLowerCase() == 'despair') {
						FlxTween.tween(FlxG.camera, {zoom: 0.75}, (Conductor.stepCrochet * 4 / 1000), {ease: FlxEase.cubeOut});
		                defaultCamZoom = 0.75;
					}
					else if (PlayState.curSong.toLowerCase() == 'overseer')
					{
				...
				if (camFollow.x != bfPos[0] && PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection)
				{
					...
					PlayState.curSong.toLowerCase() == 'friendzone' || 
					PlayState.curSong.toLowerCase() == 'extermination' || 
					PlayState.curSong.toLowerCase() == 'overseer' ||
					PlayState.curSong.toLowerCase() == 'despair')
						tweenCamInPlayer();
						...
						if (SONG.notes[Math.floor(curStep / 16)] != null)
						{
							...
							switch (Math.abs(daNote.noteData))
							{
								case 2:
									...
									if (dad.curCharacter == 'ombra')
										camGame.shake(0.003, 0.5);
								case 3:
	...
	function endSong():Void
	{
		...
		else
		{
			if (isStoryMode)
			{
				// horrible code to unlock rematch diff
		        if (FlxG.save.data.unlockedRematch != true)
			    {
					if (curSong.toLowerCase() == 'on-the-hunt') // week 1
					{
						if (FlxG.save.data.songsBeaten == 0)
							FlxG.save.data.songsBeaten = 1;
					}
					else if (curSong.toLowerCase() == 'in-stock') // week 2
					{
						if (FlxG.save.data.songsBeaten == 1)
							FlxG.save.data.songsBeaten = 2;
					}
					else if (curSong.toLowerCase() == 'encounters')
					{
						if (FlxG.save.data.songsBeaten == 2)
							FlxG.save.data.songsBeaten = 3;
					}
					else if (curSong.toLowerCase() == 'intruders') // week 3
					{
						if (FlxG.save.data.songsBeaten == 3)
							FlxG.save.data.songsBeaten = 4;
					}
					else if (curSong.toLowerCase() == 'farewell')
					{
						if (FlxG.save.data.songsBeaten == 4)
							FlxG.save.data.songsBeaten = 5;
					}
					else if (curSong.toLowerCase() == 'metal-escape') // week 4
					{
						if (FlxG.save.data.songsBeaten == 5)
							FlxG.save.data.songsBeaten = 6;
					}
					else if (curSong.toLowerCase() == 'underground') // week 5
					{
						if (FlxG.save.data.songsBeaten == 6)
							FlxG.save.data.songsBeaten = 7;
					}
					else if (curSong.toLowerCase() == 'our-battle') // week 6
					{
						if (FlxG.save.data.songsBeaten == 7)
							FlxG.save.data.songsBeaten = 8;
					}
					else if (curSong.toLowerCase() == 'change')
					{
						if (FlxG.save.data.songsBeaten == 8)
							FlxG.save.data.songsBeaten = 9;
					}
					else if (curSong.toLowerCase() == 'deep-sea') // week 7
					{
						if (FlxG.save.data.songsBeaten == 9)
							FlxG.save.data.songsBeaten = 10;
					}
					else if (curSong.toLowerCase() == 'all-aboard') // week 8
					{
						if (FlxG.save.data.songsBeaten == 10)
							FlxG.save.data.songsBeaten = 11;
					}
					else if (curSong.toLowerCase() == 'teleport') // week 9
					{
						if (FlxG.save.data.songsBeaten == 11)
							FlxG.save.data.songsBeaten = 12;
					}
					else if (curSong.toLowerCase() == 'sneaky') // week 10
					{
						if (FlxG.save.data.songsBeaten == 12)
							FlxG.save.data.songsBeaten = 13;
					}
					else if (curSong.toLowerCase() == 'cold-blood') // week 11
					{
						if (FlxG.save.data.songsBeaten == 13)
							FlxG.save.data.songsBeaten = 14;
					}
					else if (curSong.toLowerCase() == 'once-for-all')
					{
						if (FlxG.save.data.songsBeaten == 14)
							FlxG.save.data.songsBeaten = 15;
					}
					else if (curSong.toLowerCase() == 'run-away') // week 12
					{
						if (FlxG.save.data.songsBeaten == 15)
							FlxG.save.data.songsBeaten = 16;
					}
					else if (curSong.toLowerCase() == 'almost')
					{
						if (FlxG.save.data.songsBeaten == 16)
							FlxG.save.data.songsBeaten = 17;
					}
					else if (curSong.toLowerCase() == 'promenade') // winter holiday
					{
						if (FlxG.save.data.songsBeaten == 17)
						{
							FlxG.save.data.songsBeaten = 18;
							FlxG.save.data.unlockedRematch = true;
						}
					}		
	...
	override function stepHit()
	{
		...
		if (curSong.toLowerCase() == 'cold-blood' && FlxG.save.data.distractions)
			{
				switch (curStep)
				{
					case 128 | 384 | 704 | 1024 | 1152:
						defaultCamZoom = 0.90;
					case 192 | 448 | 768 | 1088:
						defaultCamZoom = 0.75;
					case 1280:
		...
		if (curSong.toLowerCase() == 'frost-fate')
		{
			switch (curStep)
			{
				case 120:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 0.75, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.95;
				case 128 | 448:
					FlxTween.tween(FlxG.camera, {zoom: 0.75}, 0.6, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.75;
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 256 | 576 | 720 | 848:
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 384 | 976:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 1.5, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.95;
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 704:
					FlxTween.tween(FlxG.camera, {zoom: 0.95}, 1.5, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.95;
				case 1104:
					FlxTween.tween(FlxG.camera, {zoom: 0.75}, 0.7, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.75;
			}
		}

		if (curSong.toLowerCase() == 'forgotten-past')
		{
			switch (curStep)
			{
				case 128 | 512:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 1.5, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.85;
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 256 | 640:
					FlxTween.tween(FlxG.camera, {zoom: 0.65}, 0.7, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.65;
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 384 | 768 | 896 | 928 | 944 | 960 | 976:
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 992:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 1.5, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.85;
		...
		if (curSong.toLowerCase() == 'overseer')
		{
			switch (curStep)
			{
				case 128 | 256 | 384 | 640 | 768 | 896 | 1024 | 1280:
					camHUD.flash(FlxColor.ORANGE, 0.5);
				case 1536:
					dad.visible = false;
					boyfriend.visible = false;
					tioBG.visible = false;
		...
		if (curSong.toLowerCase() == 'swing-it')
		{
			switch (curStep)
			{
				case 240 | 512 | 1072 | 1344 | 1792 | 2304:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 1.5, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.85;
				case 256 | 576 | 1088 | 1408 | 1920:
					FlxTween.tween(FlxG.camera, {zoom: 0.65}, 0.7, {ease: FlxEase.cubeOut});
		            defaultCamZoom = 0.65;
					camHUD.flash(FlxColor.WHITE, 0.5);
				case 832 | 2176:
		...
		if (curSong.toLowerCase() == 'despair')
		{
			switch (curStep)
			{
				...
				case 504:
					camHUD.flash(FlxColor.RED, 0.7);
					dad.visible = true;
					iconP2.visible = true;
				case 506:
					FlxG.sound.play(Paths.sound('ombraScream', 'piggy'), 1.5);
				case 508:
					FlxG.camera.zoom += 0.10;

					dad.playAnim('singLEFT', true);
					camGame.shake(0.005, 0.3);
				case 512:
					FlxTween.tween(FlxG.camera, {zoom: 0.75}, 0.7, {ease: FlxEase.cubeOut});
				case 1280 | 2080:
					FlxTween.tween(blackCountdown, {alpha: 1}, 1.2, {ease: FlxEase.cubeOut});
				case 1312 | 2112:
					FlxG.camera.zoom = 0.95;
					blackCountdown.alpha = 0;
				...
				case 2592:
					...
					FlxG.camera.zoom = 1;
					FlxTween.tween(FlxG.camera, {zoom: 0.75}, 3.4, {ease: FlxEase.cubeOut});
				case 2624:
					blackCountdown.alpha = 1;
					camHUD.alpha = 0;
			}
	...
	override function beatHit()
	{
		...
		if (FlxG.save.data.zooms)
		{
			if (curSong.toLowerCase() == 'on-the-hunt' && curBeat >= 64 && curBeat < 96 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				...
				if (curSong.toLowerCase() == 'forgotten-past' && curBeat >= 15 && curBeat < 30 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'forgotten-past' && curBeat >= 96 && curBeat < 126 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'forgotten-past' && curBeat >= 192 && curBeat < 246 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'hide-and-seek' && curBeat >= 80 && curBeat < 320 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'hide-and-seek' && curBeat >= 384 && curBeat < 544 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'frost-fate' && curBeat >= 32 && curBeat < 96 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'frost-fate' && curBeat >= 112 && curBeat < 176 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'frost-fate' && curBeat >= 180 && curBeat < 244 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'overseer' && curBeat >= 32 && curBeat < 64 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'overseer' && curBeat >= 96 && curBeat < 160 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'overseer' && curBeat >= 192 && curBeat < 224 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'overseer' && curBeat >= 144 && curBeat < 208 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'overseer' && curBeat >= 352 && curBeat < 416 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'overseer' && curBeat >= 480 && curBeat < 576 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'cold-blood' && curBeat >= 32 && curBeat < 96 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'cold-blood' && curBeat >= 112 && curBeat < 176 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'cold-blood' && curBeat >= 192 && curBeat < 256 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'despair' && curBeat >= 124 && curBeat < 256 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
				
				if (curSong.toLowerCase() == 'despair' && curBeat >= 328 && curBeat < 520 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		
				if (curSong.toLowerCase() == 'despair' && curBeat >= 592 && curBeat < 656 && camZooming && FlxG.camera.zoom < 1.35 && FlxG.save.data.distractions)
				{
					FlxG.camera.zoom += 0.020;
					camHUD.zoom += 0.04;
				}
		...
		{
			ponyRefinery.animation.play('idle'); // he do be saving his zebra /j
		}
		...
		if (curStage.startsWith('camp') && !curStage.endsWith('outdoor') && curBeat % 1 == 0 && FlxG.save.data.distractions)
		{
	...
	*/
	...
	var daFunneOffsetMultiplier:Float = 30;
...
//		bfPos[1] = boyfriend.getMidpoint().y - 460 + boyfriend.camOffset[1];
	...
	function jumpscareZee()
	{
		FlxTween.tween(FlxG.camera, {zoom: 1}, 0.001, {ease: FlxEase.cubeOut});
		defaultCamZoom = 1;

		zeeJumpscare.visible = true;
