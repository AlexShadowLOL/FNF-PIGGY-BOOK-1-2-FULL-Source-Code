...
class FreeplayPageTwo extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('data/freeplaySonglist2'));
	...
	function changeDiff(change:Int = 0)
	{
		...
		if (songs[curSelected].songName.toLowerCase() == 'cold-blood' || songs[curSelected].songName.toLowerCase() == 'promenade')
		{
			curDifficulty = 0;
		}
		else
