...
class LoadingState extends MusicBeatState
{
	...
	{		
		...
		{
			case 'meat-potatoes':
				backgrounds = new FlxSprite().loadGraphic(Paths.image('loadingBGS/loadingBG_2', 'book1'));
			...
			case 'penny-willow-tio':
				backgrounds = new FlxSprite().loadGraphic(Paths.image('loadingBGS/loadingBG_1', 'book1'));
				backgrounds.setGraphicSize(FlxG.width, FlxG.height);
				backgrounds.updateHitbox();
				backgrounds.screenCenter();
				backgrounds.antialiasing = true;
		...
		(
			function (lib)
			{
				...
				if (book1.PlayStateB1.SONG.needsVoices)
	...
	{
		return Paths.inst(book1.PlayStateB1.SONG.song);
	}
	
	static function getVocalPath()
	{
		return Paths.voices(book1.PlayStateB1.SONG.song);
	}
	...
	{
//		if (book1.PlayStateB1.storyWeek == 1)
//			Paths.setCurrentLevel("piggy");
//		else if (book1.PlayStateB1.storyWeek == 2)
//			Paths.setCurrentLevel("piggy");
//		else if (book1.PlayStateB1.storyWeek == 3)
//			Paths.setCurrentLevel("piggy");
//		else
//			Paths.setCurrentLevel("week" + book1.PlayStateB1.storyWeek);
//		#if NO_PRELOAD_ALL
//		var loaded = isSoundLoaded(getSongPath())
//			&& (!book1.PlayStateB1.SONG.needsVoices || isSoundLoaded(getVocalPath()))
//			&& isLibraryLoaded("shared");
		...
		if (!loaded)
			return new book1.LoadingState(target, stopMusic);
		#end
		if (stopMusic && FlxG.sound.music != null)
			FlxG.sound.music.stop();
